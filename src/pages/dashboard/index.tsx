...
export default function Dashboard() {
  return (
    <div className="container p-6 md:10 lg:p-16 grid grid-cols-1 md:grid-cols-7 gap-3 lg:gap-x-16 overflow-y-auto [&::-webkit-scrollbar]:hidden ">
      ...
      <div
        ...
        <h2 className="p-2 md:text-xl font-semibold text-center dark:text-white">
          이번 주 일정
        </h2>
        <WeeklyEvents />
      </div>
